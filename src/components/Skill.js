        ...
        <section className="colorlib-skills" data-section="skills">
          <div className="colorlib-narrow-content">
            ...
            <div className="row">
              ...
              >
                <p>
                  Had chances to learn some of the skills through projects and
                  also self. Here are few of them.
                </p>
              </div>
              <div
              ...
              >
                <div className="progress-wrap">
                  ...
                  <div className="progress">
                    <div
                      className="progress-bar color-10"
                      role="progressbar"
                      aria-valuenow="80"
                      aria-valuemin="0"
                      aria-valuemax="100"
              ...
              >
                <div className="progress-wrap">
                  ...
                  <div className="progress">
                    <div
                      className="progress-bar color-12"
                      role="progressbar"
                      aria-valuenow="80"
                      aria-valuemin="0"
                      aria-valuemax="100"
